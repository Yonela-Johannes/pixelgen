...
const Live = () => {
  return (
    <div className="xl:relative z-0 flex flex-col md:py-40 md:flex-row-reverse items-center bg-primary min-h-screen md:h-screen">
      <div className="xl:absolute bottom-0 z-10 right-0 flex flex-col self-end items-end justify-end xl:rounded-tl-[150px] px-10 py-10 bg-white lg:bg-primary xl:bg-white text-primary lg:text-white xl:text-primary w-full xl:w-[600px]">
        <div className="mt-10">

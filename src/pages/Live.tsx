...
const Live = () => {
  return (
    <div className="xl:relative z-0 flex flex-col md:py-40 md:flex-row-reverse items-center bg-primary min-h-screen md:h-screen">
      <div data-aos="zoom-in" data-aos-easing="linear"
        data-aos-duration="4000" className="xl:absolute bottom-0 z-10 right-0 flex flex-col self-end items-end justify-end xl:rounded-tl-[150px] px-10 py-10 bg-white lg:bg-primary xl:bg-white text-primary lg:text-white xl:text-primary w-full xl:w-[600px]">
        <div className="mt-10">
          <div className="flex md:items-center lg:w-[600px] flex-col xl:w-[480px]">
            <p className="font-acumin w-full text-4xl md:text-1xl lg:text-3xl xl:text-5xl 2xl:text-8xl mb-3">Live Concerts
            </p>
            <div className="flex flex-col gap-4 text-1xl md:text-4xl font-light">
              <p>
                ...
                mind-blowing the experience is every-time, while trying
      ...
      <div className="flex items-center justify-center md:flex-row bg-primary lg:bg-white xl:bg-primary md:h-screen w-full lg:w-[52.1%] xl:w-full">
        <div className="flex flex-col md:flex-col-reverse  gap-2 md:gap-none lg:gap-2 xl:gap-none lg:flex-col xl:flex-row-reverse items-center justify-center w-full">
          <div data-aos="zoom-in" data-aos-easing="linear"
            data-aos-duration="1500" className="xl:w-full">
          ...
          <div data-aos="zoom-in-right" data-aos-easing="linear"
            data-aos-duration="1500" className="flex items-center bg-primary lg:bg-white xl:bg-primary gap-2 md:gap-none lg:gap-2 xl:gap-10 justify-center flex-col xl:w-[50%] h-full">

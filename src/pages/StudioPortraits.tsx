...
const StudioPortraits = () => {
  return (
    <div className="flex flex-col lg:flex-row-reverse xl:flex-row items-center bg-white lg:bg-primary xl:bg-white min-h-screen lg:h-screen md:h-screen text-primary lg:text-white xl:text-primary">
      <div className="flex flex-col items-center h-full justify-end w-full lg:w-full xl:w-[50%]">
        <div className="p-8 md:p-0 mt-10">
          ...
          <p className="w-full text-4xl md:text-1xl lg:text-3xl xl:text-5xl 2xl:text-8xl mb-3">Studio Portraits
            </p>
